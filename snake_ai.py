...
pygame.init()
font =  pygame.font.Font('Graphic/font/Reglisse.otf', 30)
...
class SnakeGame_AI:
    ...
    def _update_ui(self):
        ...
        for pt in self.snake:
            pygame.draw.rect(self.display, PURPLE, pygame.Rect(pt.x, pt.y, BLOCK_SIZE, BLOCK_SIZE))
            pygame.draw.rect(self.display, PURPLE2, pygame.Rect(pt.x + 4, pt.y + 4, 12, 12))
        
        pygame.draw.rect(self.display, LIME, pygame.Rect(self.food.x, self.food.y, BLOCK_SIZE, BLOCK_SIZE))
